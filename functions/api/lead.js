...
export async function onRequestPost({ request, env }) {
  ...
  await transporter.sendMail({ from: 'hello@uplof.me', to: 'kumarabhishekbuild@gmail.com', subject: 'New Uplof lead audit enquiry', text: body, replyTo: email });
  await transporter.sendMail({ from: 'hello@uplof.me', to: email, subject: 'We received your Uplof enquiry', text: `Hi ${name},\n\nThanks for contacting Uplof. We received your enquiry and will reply shortly.\n\n— Uplof`, replyTo: 'hello@uplof.me' });
